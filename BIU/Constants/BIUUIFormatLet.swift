...
//背景颜色
let BIUColorBackground              = BIUGetColorWithRed(245, green: 245, blue: 245);
//分割线颜色
...
//边框颜色
let BIUColorLineBorder              = BIUGetColorWithRed(204, green: 204, blue: 204);


/**
 *  Font
 */
let BIUFontTextHeadLine             = UIFont.systemFontOfSize(14.0);
let BIUFontTextHeadLineBold         = UIFont.boldSystemFontOfSize(14.0);
let BIUFontTextDefault              = UIFont.systemFontOfSize(12.0);
let BIUFontTextDescribe             = UIFont.systemFontOfSize(10.0);
...
/**
 *  Label Height (与字体大小对应)
 */
let BIULabelHeightHeadLine          = CGFloat(14.0);
let BIULabelHeightDefault           = CGFloat(12.0);
let BIULabelHeightDescribe          = CGFloat(10.0);
...
let BIUSpaceSmallest                = CGFloat(10.0);
